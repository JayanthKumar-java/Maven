...
public class FinolexDDB extends HttpServlet {
...
*/	
				...
				{
					initiatePullMoneyRequestRequest(request, response,aLogHID,debug);
				}
				else
				{
...
//			return configurableValues;
	...
	private void initiatePullMoneyRequestRequest(HttpServletRequest request, HttpServletResponse response,String aLogHID,boolean debug) throws IOException, URISyntaxException
	{
	...
	/*	wholeParamString = ConfigValues;
		...
		//clientCode="ART";
		//merchantCode="WT-1040";
		//WSURL="https://demo.b2biz.co.in/ws/walletAPI_EXT";
		clientCode="FINI";
		WSURL="https://www.b2biz.co.in/ws/walletAPI_EXT";
		merchantCode="WT-1186";
