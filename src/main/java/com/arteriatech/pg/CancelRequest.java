...
public class CancelRequest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String cancelRequest="{\"TXNTYPE\": \"AUTCAN\",\"DLRCODE\": \"138851\",\"DEALID\": \"CS025964945370\",\"ORDERNO\": \"ArvindTestOrder100\",\"RRN\": \"ArvindCancel\",\"LOANAMT\": \"10000\",\"DLRVKEY\": \"8491843317222182\"}";
		String encodedValue = "", sealValue="", decodedValue="", encryptedResponse="";
		try{
			JsonParser jsonParser = new JsonParser();
			JsonObject bflObj = (JsonObject)jsonParser.parse(cancelRequest);
