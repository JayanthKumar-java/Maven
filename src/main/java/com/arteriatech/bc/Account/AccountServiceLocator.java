...
public class AccountServiceLocator extends org.apache.axis.client.Service implements com.arteriatech.bc.Account.AccountService {
    ...
    private java.lang.String AccountPort_address = "https://e1044-iflmap.hcisbt.ap1.hana.ondemand.com:443/cxf/ARTEC/BC/LinkedAccount/CurrentAccount";
    ...
    public com.arteriatech.bc.Account.Account getAccountPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.arteriatech.bc.Account.AccountBindingStub _stub = new com.arteriatech.bc.Account.AccountBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.arteriatech.bc.Account.Account.class.isAssignableFrom(serviceEndpointInterface)) {
                com.arteriatech.bc.Account.AccountBindingStub _stub = new com.arteriatech.bc.Account.AccountBindingStub(new java.net.URL(AccountPort_address), this);
                _stub.setPortName(getAccountPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bc.arteriatech.com/Account", "AccountService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bc.arteriatech.com/Account", "AccountPort"));
        }
