...
public class ESignContractCALProprietorshipSecondary extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String inputPayload = "", wsURL = "", userName = "", passWord = "", userpass = "",
				esignContractCalProShipSecEndPoint = "", esignContractCalProShipSecres = "";
		boolean debug = false;
		...
		try {
			...
			if (inputPayload != null && !inputPayload.equalsIgnoreCase("")) {
				...
				if (wsURL != null && !wsURL.equalsIgnoreCase("")) {
					...
					esignContractCalProShipSecEndPoint = properties.getProperty("eSignContractCALProprietorshipSecondary");
					wsURL = wsURL.concat(esignContractCalProShipSecEndPoint);
					if (debug) {
						response.getWriter().println("ESignContractCALProprietorshipSecondary cpi  Url: " + wsURL);
					}
					...
					if ((resCode / 100) == 2) {
						...
						esignContractCalProShipSecres = sb.toString();
						JsonParser jsonParser = new JsonParser();
						JsonObject responseJson = (JsonObject) jsonParser.parse(esignContractCalProShipSecres);
