...
public class Call2SCFeSignContractUpdateRetry extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String inputPayload = "", wsURL = "", userName = "", passWord = "", userpass = "", cl2ScfCntUpdateEndPoint = "",
				cl2ScfCntUpdateres = "";
		boolean debug = false;
		...
		try {
			...
			if (inputPayload != null && !inputPayload.equalsIgnoreCase("")) {
				...
				if (wsURL != null && !wsURL.equalsIgnoreCase("")) {
					...
					cl2ScfCntUpdateEndPoint = properties.getProperty("Call2SCFeSignContractUpdateRetry");
					wsURL = wsURL.concat(cl2ScfCntUpdateEndPoint);
					if (debug) {
						response.getWriter().println("Call2SCFeSignContractUpdateRetry cpi  Url: " + wsURL);
					}
					...
					if ((resCode / 100) == 2) {
						...
						cl2ScfCntUpdateres = sb.toString();
						JsonParser jsonParser = new JsonParser();
						JsonObject responseJson = (JsonObject) jsonParser.parse(cl2ScfCntUpdateres);
