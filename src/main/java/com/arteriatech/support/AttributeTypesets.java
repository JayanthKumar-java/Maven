...
public class AttributeTypesets extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String inputPayload="",wsURL="",userName="",passWord="",userpass="",attributeTypeListEndPoint="",attributeTypesetsres="";
		boolean debug=false;
		...
		try {
			...
			if (inputPayload != null && !inputPayload.equalsIgnoreCase("")) {
				...
				if (wsURL != null && !wsURL.equalsIgnoreCase("")) {
					...
					attributeTypeListEndPoint = properties.getProperty("SM34_ATYP_GETLST");
					wsURL = wsURL.concat(attributeTypeListEndPoint);
					if (debug) {
						response.getWriter().println("AttributeTypeList  Url: " + wsURL);
					...
					if ((resCode / 100) == 2) {
						...
						attributeTypesetsres = sb.toString();
						JsonParser jsonParser = new JsonParser();
						JsonObject responseJson = (JsonObject) jsonParser.parse(attributeTypesetsres);
