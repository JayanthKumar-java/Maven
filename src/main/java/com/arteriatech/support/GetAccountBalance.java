...
public class GetAccountBalance extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().println("Hello Account Balance");
		String inputPayload = "";
		try {
			...
			if (!accNumber.equalsIgnoreCase("")) {
				...
				Map<String, String> callAccountBalanceMap = accountBalanceClient.callAccountBalance(accNumber,
						aggregatorID, corpId, userId, userRegId, debug);
